...
export const LandingPage: React.FC<LandingPageProps> = ({ onGetStarted, onLogin, language, onLanguageChange }) => {
  ...
  return (
    <div className="min-h-screen bg-proton-bg text-proton-text font-sans overflow-x-hidden selection:bg-proton-accent selection:text-proton-bg">
      ...
      <nav className="fixed top-0 w-full z-[100] border-b border-proton-border/50 bg-proton-bg/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            {/* Language Switcher */}
            <div className="flex bg-proton-card rounded-lg p-1 border border-proton-border">
              <button 
            ...
            <button 
              onClick={onLogin}
              className="text-sm font-bold uppercase tracking-widest text-proton-muted hover:text-proton-text transition-colors hidden sm:block"
            >
              {t.cta_login}
            </button>
            <button 
              onClick={onGetStarted}
              className="px-6 py-2.5 bg-proton-accent text-proton-bg rounded-xl text-sm font-bold uppercase tracking-widest hover:scale-105 active:scale-95 transition-all shadow-lg shadow-proton-accent/20"
            >
              {t.cta_start}
            </button>
          </div>
      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center flex flex-col items-center">
          ...
          >
            ...
            <p className="text-xl text-proton-muted mb-12 leading-relaxed max-w-2xl mx-auto">
              {t.hero_subtitle}
            </p>
        ...
        <motion.div 
          ...
          className="max-w-5xl mx-auto mt-24 relative px-4"
        >
      ...
      {/* Features Grid */}
      <section className="py-24 px-6 border-t border-proton-border/50">
