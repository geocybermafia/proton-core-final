export const translations = {
  ...
  ka: {
    ...
    hub: {
      welcome: "გამარჯობა,",
      subtitle: "თქვენი სამუშაო სივრცე მზადაა.",
    ...
    organizer: {
      ...
      energy_filter: "გაფილტრეთ სირთულის მიხედვით:",
    ...
    cabinet: {
      ...
      language_desc: "აირჩიეთ სასურველი ენა",
      notifications_label: "შეტყობინებები",
      notifications_desc: "მიიღეთ ინფორმაცია სიახლეების შესახებ",
      ...
      design_desc: "აირჩიეთ აპლიკაციის გარეგნობა",
      theme_auto: "სისტემური (Auto)",
      theme_enterprise: "Enterprise",
      theme_light: "ნათელი",
