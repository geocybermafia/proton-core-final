export const translations = {
  en: {
    ...
    dashboard: {
      ...
      security_verification: "Secure Connection",
      security_msg: "Security verification completed successfully.",
      optimization_btn: "Start Optimization",
      stats: {
    ...
    landing: {
      ...
      hero_subtitle: "Proton brings together smart AI assistants, dynamic process planners, and local trading into an incredibly simple digital home for your daily routines and business growth.",
      cta_start: "Get Started Free",
      cta_login: "Sign In",
      badge_text: "A simpler way to scale your ideas",
      ecosystem_title: "All-In-One Unified Environment",
      ecosystem_subtitle: "Simple but powerful tools designed to automate your manual tasks and fast-track your growth.",
      feature_1_title: "AI Helpers",
      feature_1_desc: "Collaborative digital assistants ready to handle tasks, analyze data, and support you 24/7.",
      feature_2_title: "Smart Local Market",
      feature_2_desc: "Easily sell and buy goods, services, or digital assets inside a secure local ecosystem.",
      feature_3_title: "Visual Planners",
      feature_3_desc: "Map out, organize, and automate your workflows with intuitive drag-and-drop systems.",
    ...
    systems: {
      ...
      intelligence_level: "AI Capabilities",
      intelligence_desc: "Configure AI intensity and complexity.",
  ...
  ka: {
    ...
    diagnostic: {
      ...
      matrix: "სისტემის ტესტირება...",
      running: "პროცესების დამუშავება...",
    ...
    dashboard: {
      ...
      security_verification: "დაცული კავშირი",
      security_msg: "უსაფრთხოების შემოწმება წარმატებით დასრულდა.",
      optimization_btn: "ოპტიმიზაციის დაწყება",
      stats: {
        storage: "გამოყენებული მეხსიერება",
        work: "აქტიურობა",
        energy: "AI რესურსები",
    ...
    landing: {
      ...
      hero_subtitle: "Proton-ი აერთიანებს პერსონალურ AI ასისტენტებს, დავალებების მარტივ ორგანიზატორს და თბილ სავაჭრო სივრცეს. შექმნილია თქვენი ყოველდღიური კომფორტული წინსვლისთვის.",
      cta_start: "დაიწყე უფასოდ",
      cta_login: "შესვლა",
      badge_text: "უფრო მარტივი გზა თქვენი მიზნების მისაღწევად",
      ecosystem_title: "ყოვლისმომცველი და მეგობრული სივრცე",
      ecosystem_subtitle: "მარტივი, მაგრამ ძლიერი ხელსაწყოები, რომლებიც გიფრთხილდებიან დროს და გიადვილებენ ყოველდღიურობას.",
      feature_1_title: "ჭკვიანი დამხმარეები",
      feature_1_desc: "პერსონალური AI ასისტენტების გუნდი, რომელიც მზად არის დაგეხმაროთ ნებისმიერ დროს, 24/7.",
      feature_2_title: "თბილი მარკეტი",
      feature_2_desc: "ივაჭრეთ ნივთებით, მომსახურებით ან ციფრული აქტივებით დაცულ და მეგობრულ გარემოში.",
      feature_3_title: "მარტივი ორგანიზატორი",
      feature_3_desc: "მოაწესრიგეთ თქვენი ყოველდღიური საქმეები, დავალებები და გეგმები სულ რაღაც წამებში.",
    ...
    systems: {
      ...
      active: "აქტიური",
      latency: "ქსელის დაყოვნება",
      data_sync: "მონაცემთა სინქრონიზაცია",
      synchronized: "სინქრონიზებულია",
      operational: "ოპერაციული",
      intelligence_level: "AI შესაძლებლობები",
      intelligence_desc: "AI-ს ინტენსივობის კონფიგურაცია.",
    ...
    workflows: {
      ...
      builder: {
        node_library: "ელემენტების ბიბლიოთეკა",
        ...
        empty_canvas: "სამუშაო გარემო ცარიელია",
        empty_desc: "დაამატეთ ელემენტები ბიბლიოთეკიდან ავტომატიზაციის დასაწყებად."
      }
    },
    image_studio: {
    ...
    settings: {
      ...
      voice: "ხმის სინთეზი",
      system_prompt: "სისტემური მითითება",
      profile_desc: "პერსონალური მონაცემების მართვა.",
