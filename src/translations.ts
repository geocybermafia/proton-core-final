export const translations = {
  en: {
    ...
    landing: {
      ...
      ecosystem_title: "Technological Ecosystem",
      ecosystem_subtitle: "A labor-oriented platform that gives you tools for real growth.",
      feature_1_title: "AI Council",
      feature_1_desc: "Specialized AI agents working for your business 24/7.",
      feature_2_title: "Global Marketplace",
      feature_2_desc: "Trade assets, services and physical items in a high-tech environment.",
      feature_3_title: "Node Logic",
      feature_3_desc: "Automate complex processes with our visual architect.",
  ...
  ka: {
    ...
    landing: {
      ...
      ecosystem_title: "ტექნოლოგიური ეკოსისტემა",
      ecosystem_subtitle: "შრომაზე ორიენტირებული პლატფორმა, რომელიც გაძლევთ ინსტრუმენტებს ზრდისთვის.",
