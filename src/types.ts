...
export type View = 'translator' | 'dashboard' | 'compute' | 'personas' | 'blueprints' | 'profile' | 'settings' | 'image' | 'organizer' | 'device' | 'documentation' | 'market' | 'commercial' | 'market-hub' | 'finance' | 'business-hub' | 'creative-studio' | 'copywriting' | 'clips';
